...
INSERT INTO `phoneno` (`phonenoID`, `UserID`, `phoneNo`) VALUES
(1, 1, '123456789'),
(2, 2, '0774564897'),
(3, 14, '0716086900'),
(5, 17, '0716086001'),
...
INSERT INTO `users` (`UserID`, `LastName`, `FirstName`, `Password`, `Role`, `address`) VALUES
(1, 'Samarajeewa', 'Heshara', '1205k', 0, '910, sri jayanthi mawatha'),
(2, 'Samarajeewa', 'Yasal', '1305y', 2, '911, kanthi mawatha'),
(18, NULL, '33@3mail.com', NULL, NULL, 'colombo002');
...
--
ALTER TABLE `phoneno`
  MODIFY `phonenoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
